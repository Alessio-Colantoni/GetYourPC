...
Le password e i codici di verifica sono salvati come hash BCrypt. I codici sono numerici di cinque cifre, scadono dopo dieci minuti e consentono al massimo cinque tentativi. Un cambio o recupero password rende non valide le sessioni precedenti.
...
Il file `.env.example` contiene valori segnaposto. Spring Boot non lo carica automaticamente.
