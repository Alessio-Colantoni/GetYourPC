...
public class BootstrapAccountInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (created) {
            LOGGER.info("Account iniziale creato per {}. Disabilitare subito il bootstrap e rimuovere la password dall'ambiente.", email);
        } else {
            LOGGER.info("Bootstrap ignorato: esiste gia' un account con email {}.", email);
        }
    }
